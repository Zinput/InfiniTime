...
namespace {
  void event_handler(lv_obj_t* obj, lv_event_t event) {
    SettingSleep* screen = static_cast<SettingSleep*>(obj->user_data);
...
SettingSleep::SettingSleep(Pinetime::Controllers::Settings& settingsController) : settingsController {settingsController} {
  ...
  lv_label_set_text_static(icon, Symbols::sleepTrack);
  ...
  lv_obj_t* btnPlusLabel = lv_label_create(btnPlus, nullptr);
  lv_obj_set_style_local_text_font(btnPlusLabel, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, &jetbrains_mono_42);
  lv_label_set_text_static(btnPlusLabel, "+");
  ...
  lv_obj_t* btnMinusLabel = lv_label_create(btnMinus, nullptr);
  lv_obj_set_style_local_text_font(btnMinusLabel, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, &jetbrains_mono_42);
  lv_label_set_text_static(btnMinusLabel, "-");
